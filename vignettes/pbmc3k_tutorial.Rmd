...
We will now look at [GSE96583](https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE96583). For speed, we will be looking at a subset of 5000 cells from this data. The cells in this dataset were pooled from eight individual donors. This data contains two batches of single cell sequencing. One of the batches was stimulated with IFN-beta.
...
* cell is the cell types identified by the authors of this dataset.
* multiplets classifies cells as single or doublet, using genetic differences between the eight individuals.
...
DimPlot(kang, reduction="umap_harmony", group.by="ind")
...
DimPlot(kang, reduction="umap", group.by="cell")
```

Data integration using Harmony is useful for exploring the data and identifying clusters. For differential expression analysis, we might instead leave the data as-is, and include batches (etc) as extra predictors in a linear model.
