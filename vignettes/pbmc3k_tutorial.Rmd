...
We suggest working from the `pbmc3k_tutorial.R` script that you would have downloaded as part of the [workshop setup instructions](installation.html). This script will have all the code that we will be using for the duration of the workshop.
